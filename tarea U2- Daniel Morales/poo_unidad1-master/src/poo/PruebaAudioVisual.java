...
public class PruebaAudioVisual {
    public static void main(String[] args) {
        ...
        // Crear video musical
        VideoMusical videoMusical = new VideoMusical("Cats", 4, "Pop", "Laland", "Joan Doe");
        contenidos[3] = videoMusical;

        // Crear podcast
        Podcast podcast = new Podcast("Código Abierto: Conversaciones sobre Tecnología", 70, "Entrevista", "Daniel Morales", "AudioVisual"); 
